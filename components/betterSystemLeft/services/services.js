...
const Services = ({ data }) => {
  ...
  console.log(data, "serverices");

  const [singlePost, setSinglePost] = useState({});
  console.log(singlePost, "male");

  const getSinglePost = useCallback(
    (slug) => {
      if (slug === undefined) {
        const post = data.nodes[0].posts.nodes.find(
          (post) => post.slug === "male-hot"
        );
        setSinglePost(post);
      } else {
        const post = data.nodes[0].posts.nodes.find(
        ...
        <div className={styles.container}>
          <div>
            <div className={`${styles.maleFemale} biologyMain`}>
              ...
              <Link href="/systems-biology/female/#female">
                <a>
                  <button
          ...
          <div className={styles.roundCards}>
            <div
              onClick={() => getSinglePost("male-hot")}
              className={`${styles.card} ${
                singlePost.slug === "male-hot" ? styles.activeClass : ""
              }`}
            >
              <div
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={
                      singlePost.slug === "male-hot" ? "#ffffff" : IconColor
                    }
                  ></path>
                  <path
            ...
            <div
              onClick={() => getSinglePost("male-cold")}
              className={`${styles.card} ${
                singlePost.slug === "male-cold" ? styles.activeClass : ""
              }`}
            >
              <div
                style={{ background: bgColor }}
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={
                      singlePost.slug === "male-cold" ? "#ffffff" : IconColor
                    }
                    stroke={
                      singlePost.slug === "male-cold" ? "#ffffff" : IconColor
                    }
            ...
            <div
              onClick={() => getSinglePost("male-blood")}
              className={`${styles.card} ${
                singlePost.slug === "male-blood" ? styles.activeClass : ""
              }`}
            >
              <div
                style={{ background: bgColor }}
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={
                      singlePost.slug === "male-blood" ? "#ffffff" : IconColor
                    }
                  ></path>
                  <path
            ...
            <div
              onClick={() => getSinglePost("male-flow")}
              className={`${styles.card} ${
                singlePost.slug === "male-flow" ? styles.activeClass : ""
              }`}
            >
              <div
                style={{ background: bgColor }}
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={
                      singlePost.slug === "male-flow" ? "#ffffff" : IconColor
                    }
                  ></path>
                  <path
            ...
            <div
              onClick={() => getSinglePost("male-fluids")}
              className={`${styles.card} ${
                singlePost.slug === "male-fluids" ? styles.activeClass : ""
              }`}
            >
              <div
                style={{ background: bgColor }}
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={
                      singlePost.slug === "male-fluids" ? "#ffffff" : IconColor
                    }
                  ></path>
                  <path
            ...
            <div
              onClick={() => getSinglePost("male-energy")}
              className={`${styles.card} ${
                singlePost.slug === "male-energy" ? styles.activeClass : ""
              }`}
            >
              <div
                style={{ background: bgColor }}
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={
                      singlePost.slug === "male-energy" ? "#ffffff" : IconColor
                    }
                  ></path>
                  <path
